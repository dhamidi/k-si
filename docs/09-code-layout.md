...
├── msg/                           # email's contract: tags/payloads/constructors others use ([15])
...
```
tasks/
├── msg/                           # tasks' contract: create-task, append-to-task, … ([15])
...
- **Contracts are leaf packages.** The tags, payloads, and constructors
